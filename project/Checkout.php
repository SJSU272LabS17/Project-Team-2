  ...
  <body>
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							<div class="panel-title">
								<div class="row">
									<div class="col-xs-7">
										<h2><span class="glyphicon glyphicon-shopping-cart"></span> Order Summary</h2>
									</div>
									<div class="col-xs-2">
	    ...
	    $item_count=0;
			while($row=mysqli_fetch_assoc($result)){
									...
									<div class="row">
										...
										<div class="col-xs-3">
											<div class="col-xs-6 text-right">
												<h6 style="font-size:18px;"><strong><?= $units ?></h6>
											</div>
										</div>
                    <div class="col-xs-3">
											<div class="col-xs-6 text-right">
												<h6 style="font-size:18px;">$<?= $sub_total ?></h6>
											</div>
										</div>
									</div>
									<hr>
                ...
                <div class="col-xs-6">
                  <h4>Congrats! Your order is successful</h4>
  							</div>
								<div class="col-xs-4">
